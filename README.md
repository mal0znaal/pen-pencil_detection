...
|-----------|--------|--------|--------|--------:|--------:|-------------:|
| YOLOv12s  | all    | 0.966  | 0.972  | 0.9691  | 0.980   | 0.667        |
| YOLOv12s  | pen    | 0.993  | 1.000  | ------- | 0.995   | 0.714        |
| YOLOv12s  | pencil | 0.938  | 0.944  | ------- | 0.965   | 0.621        |
...
| Model     | Class  | P      | R      |   F1    | mAP@0.5 | mAP@0.5:0.95 |
|-----------|--------|--------|--------|--------:|--------:|-------------:|
| YOLOv11s  | all    | 0.916  | 0.959  | 0.9371  | 0.978   | 0.690        |
| YOLOv11s  | pen    | 0.935  | 0.962  | ------  | 0.989   | 0.688        |
| YOLOv11s  | pencil | 0.896  | 0.957  | ------  | 0.968   | 0.692        |
...
Из интересного: **RT-DETR-L** безошибочно определяет `карандаши` (не делает ложных предсказаний), а **YOLOv12s** безошибочно определяет все `ручки` (не пропускает ни одну ручку).  Шутки ради можно было бы попробовать сделать **ансамбль** этих двух моделей.
